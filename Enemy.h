...
class Enemy  {
  ...
  public:
    ...
    virtual void moveEnemy();  // will describe the motion of each of the enemies in derived classes
    virtual int DeadState();  // will be used to determine if the enemy is dead and should leave the screen or is in another state
